...
### Windows quick install (after installing Python as described above)

1. Run `install.bat` to create the `.venv` and install dependencies.
2. Run `run.bat` to launch the app.
